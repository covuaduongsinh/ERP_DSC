// ============================================================
// @vierp/events - CoVua (Cờ vua Dương Sinh) Event Schemas
// Sự kiện từ module CoVua (trung tâm dạy cờ) phát lên NATS để đồng bộ ERP:
//   covua.payment.received → Accounting (ghi nhận doanh thu học phí)
//   covua.coach.upserted   → HRM (đồng bộ giáo viên ↔ nhân sự)
//   covua.lead.captured    → CRM (gom lead tuyển sinh)
// ============================================================
...
export type TuitionPaymentReceived = z.infer<typeof TuitionPaymentReceivedSchema>;
...
/** Export tất cả schema sự kiện CoVua (subject → schema). */
export const CoVuaEventSchemas = {
  'covua.payment.received': TuitionPaymentReceivedSchema,
  'covua.coach.upserted': CoachUpsertedSchema,
  'covua.lead.captured': LeadCapturedSchema,
} as const;
