...
import { buildClassDuplicateData, DUPLICATE_TITLE_SUFFIX } from '@/lib/classes/duplicate'
...
const baseClass: Class = {
  ...
  siSoToiDa: 20,
  trangThai: 'dang_mo',
  lichHoc: [{ id: 'slot-1', thu: 't3', gioBatDau: '17:00', gioKetThuc: '18:30', phong: 'A1' }],
...
describe('buildClassDuplicateData', () => {
  it('thêm hậu tố (bản sao) vào tên', () => {
    ...
    expect(data.title).toBe(`Nhập môn - Kim Liên - Thứ 3${DUPLICATE_TITLE_SUFFIX}`)
  })
