...
export const Leads: CollectionConfig = {
  ...
  admin: {
    // Phễu tuyển sinh đã chuyển sang CRM (app CRM, /admissions). Ẩn collection khỏi
    // mọi nav/quick-create của admin CLB để tránh trùng lặp & dual source-of-truth.
    // Dữ liệu + access + endpoint handoff vẫn giữ nguyên (chỉ ẩn UI nhập liệu).
    hidden: true,
