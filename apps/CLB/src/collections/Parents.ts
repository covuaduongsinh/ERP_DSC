...
import { staffOnly, readParentSelf, updateParentSelf, staffOnlyFieldWrite } from '../access/parents'
...
export const Parents: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      index: true,
      admin: {
        description: 'Định danh đăng nhập. Lưu dạng chuẩn hóa, không khoảng trắng/dấu.',
      },
      access: {
    ...
    },
    {
      ...
      hasMany: true,
      admin: {
        description: 'Học viên mà phụ huynh này theo dõi. Đồng bộ với Students.parents khi gán.',
      },
      access: {
        create: staffOnlyFieldWrite,
        update: staffOnlyFieldWrite,
