...
export async function UpcomingEventsSection({ events, locale }: UpcomingEventsSectionProps) {
                ...
                >
                  <div className="flex items-center gap-4 bg-[linear-gradient(150deg,var(--ds-primary),var(--ds-navy-deep))] p-5 text-white">
                    <div className="flex h-14 w-14 shrink-0 flex-col items-center justify-center rounded-ds-md bg-white text-navy">
                      <span className="font-cond text-[22px] font-black leading-none">{day}</span>
                      <span className="font-cond text-[11px] font-bold uppercase">{month}</span>
                    </div>
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    {event.summary && (
                      <p className="text-sm leading-relaxed text-[#4a4f63]">{event.summary}</p>
                    )}
