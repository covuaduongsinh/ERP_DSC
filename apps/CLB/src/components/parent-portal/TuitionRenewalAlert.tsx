...
export function TuitionRenewalAlert({ student, tuition }: TuitionRenewalAlertProps) {
  if (!isTuitionLow(tuition)) return null

  return (
    <div className="mb-4 rounded-xl border border-primary/30 bg-primary/5 px-4 py-3" role="status">
