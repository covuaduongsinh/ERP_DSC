...
export async function BookCard({ book }: BookCardProps) {
  ...
  const image = typeof book.image === 'object' && book.image !== null ? book.image : null
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <h3 className="mt-1 text-base font-bold leading-tight text-ink">{book.title}</h3>
        {book.shortDesc && (
          <p className="mt-2 line-clamp-2 text-[13px] leading-snug text-muted">{book.shortDesc}</p>
        )}
