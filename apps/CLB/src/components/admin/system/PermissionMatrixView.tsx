...
const GROUPS: CapGroup[] = [
  ...
  },
  {
    ...
    caps: [
      {
        label: 'Điểm danh / nhận xét buổi',
        roles: ALL_STAFF,
        note: 'staffOnly — mọi nhân viên (đọc theo cơ sở)',
      },
        ...
        <header className="ds-pghead" style={{ marginBottom: 18 }}>
          <div>
            ...
            <p className="ds-pghead__sub">
              Tài liệu sống — sinh từ <code>access/roles.ts</code> + các gate{' '}
              <code>hasRole(…)</code>. Hàng rào thật ở tầng access (server-side), không chỉ ẩn UI.
            </p>
          </div>
        </header>
