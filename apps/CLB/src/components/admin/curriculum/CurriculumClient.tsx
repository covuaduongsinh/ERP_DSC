            ...
            >
              ...
              <label className="ds-field" style={{ display: 'block' }}>
                ...
                <input
                  ...
                  type="text"
                  value={form.tenKhung}
                  onChange={(e) => setField('tenKhung', e.target.value)}
                  disabled={busy}
                />
              </label>
              <div
              ...
              >
                <label className="ds-field" style={{ flex: '1 1 140px' }}>
                  ...
                  <select
                    className="ds-select"
                    value={form.capDo}
                    onChange={(e) => setField('capDo', e.target.value)}
                    disabled={busy}
                  >
                    {LEVEL_OPTIONS.map((o) => (
                ...
                <label className="ds-field" style={{ flex: '1 1 140px' }}>
                  ...
                  <select
                    className="ds-select"
                    value={form.tuyen}
                    onChange={(e) => setField('tuyen', e.target.value)}
                    disabled={busy}
                  >
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ display: 'inline-flex', gap: 4 }}>
                        ...
                        <button
                          type="button"
                          className="ds-tbl__link"
                          disabled={busy || idx === form.baiHoc.length - 1}
                          onClick={() => moveLesson(idx, 1)}
                          title="Xuống"
                        >
                          ↓
                    ...
                    <label className="ds-field" style={{ display: 'block' }}>
                      ...
                      <input
                        ...
                        type="text"
                        value={l.tieuDe}
                        onChange={(e) => setLesson(idx, 'tieuDe', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                    <label className="ds-field" style={{ display: 'block', marginTop: 6 }}>
                      ...
                      <textarea
                        ...
                        rows={2}
                        value={l.mucTieu}
                        onChange={(e) => setLesson(idx, 'mucTieu', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                    <label className="ds-field" style={{ display: 'block', marginTop: 6 }}>
                      ...
                      <textarea
                        ...
                        rows={2}
                        value={l.kienThucMoi}
                        onChange={(e) => setLesson(idx, 'kienThucMoi', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                    <label className="ds-field" style={{ display: 'block', marginTop: 6 }}>
                      ...
                      <textarea
                        ...
                        rows={2}
                        value={l.giaoBTVN}
                        onChange={(e) => setLesson(idx, 'giaoBTVN', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                    <label className="ds-field" style={{ display: 'block', marginTop: 6 }}>
                      ...
                      <input
                        ...
                        type="text"
                        value={l.sachDangHoc}
                        onChange={(e) => setLesson(idx, 'sachDangHoc', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                    <label className="ds-field" style={{ display: 'block', marginTop: 6 }}>
                      ...
                      <textarea
                        ...
                        rows={1}
                        value={l.ghiChu}
                        onChange={(e) => setLesson(idx, 'ghiChu', e.target.value)}
                        disabled={busy}
                      />
                    </label>
                  </fieldset>
