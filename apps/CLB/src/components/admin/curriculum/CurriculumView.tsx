      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Biên soạn <strong>giáo trình mẫu theo cấp</strong> (Tốt → Mã → Tượng → Xe → Hậu → Vua) —
            danh sách bài có thứ tự để mọi cơ sở dạy đồng nhất. Ở trang{' '}
            <strong>Lập kế hoạch buổi học</strong>, HLV bấm “Áp khung lộ trình” để điền sẵn nội dung
            các buổi theo khung này. Khung dùng chung toàn công ty.
          </p>
        </header>
        {canManage ? (
          <CurriculumClient />
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Chỉ <strong>quản lý</strong> hoặc <strong>admin</strong> mới được biên soạn khung lộ
            trình. Bạn vẫn xem được và áp khung ở trang Lập kế hoạch buổi học.
          </p>
        )}
      </Gutter>
    </DefaultTemplate>
