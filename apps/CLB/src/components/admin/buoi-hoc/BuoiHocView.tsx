      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Chọn lớp và ngày, nhập nội dung buổi (kiến thức mới, BTVN, kế hoạch) và điểm danh + nhận
            xét từng học viên, rồi lưu. Lưu lại cùng ngày sẽ cập nhật, không tạo trùng. Có thể hủy
            buổi hoặc tạo buổi dạy bù.
          </p>
        </header>
        {classes.length === 0 ? (
          <p style={{ color: 'var(--theme-elevation-500)' }}>
