      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Lương theo <strong>buổi đứng lớp</strong>: số buổi (gộp HV cùng buổi) × đơn giá/buổi đặt
            ở hồ sơ Giáo viên. Chỉ tài chính xem.
          </p>
        </header>
            ...
            {data && data.rows.length > 0 ? (
              <>
                ...
                <p className="ds-muted" style={{ marginTop: 8, fontSize: 12 }}>
                  GV hiển thị “— (chưa set)” cần điền <strong>Lương mỗi buổi</strong> ở hồ sơ Giáo
                  viên.
                </p>
              </>
            ) : (
