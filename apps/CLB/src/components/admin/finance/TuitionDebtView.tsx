      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Học viên <strong>sắp hết số buổi tồn</strong> (cần nhắc đóng kỳ tiếp) và các phiếu thu
            còn trạng thái “Chờ”. Toàn cơ sở. Xem đầy đủ số buổi tồn &amp; đối soát ở mục{' '}
            <strong>Số buổi tồn</strong>.
          </p>
        </header>
        <TuitionDebtClient lowStudents={debt.lowStudents} pendingPayments={debt.pendingPayments} />
      </Gutter>
    </DefaultTemplate>
  )
}
