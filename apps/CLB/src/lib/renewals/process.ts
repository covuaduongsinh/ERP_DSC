...
export const PROCESSABLE_RENEWAL_STATUSES: RenewalRequest['status'][] = ['moi', 'dang_xu_ly']
  ...
  try {
    ...
    if (transactionID) {
      ...
      try {
        ...
        console.error('[approveRenewalRequest] Gỡ chu kỳ mồ côi thất bại — cần soát tay:', {
