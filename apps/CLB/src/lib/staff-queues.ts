 ...
 */
export const FOLLOW_UP_LEAD_STATUSES: Lead['status'][] = ['da_lien_he', 'dang_ky_hoc_thu']

/** Trạng thái RenewalRequest coi là "đang chờ" nhân viên xử lý. */
export const PENDING_RENEWAL_STATUSES: RenewalRequest['status'][] = ['moi', 'dang_xu_ly']
...
export async function countUncaredLeads(payload: Payload, user: User | null): Promise<number> {
