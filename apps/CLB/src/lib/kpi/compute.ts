...
export const LEAD_SOURCES: readonly LeadSource[] = ['google', 'facebook', 'gioi_thieu', 'khac']

const CONTACTED_STATUSES: readonly LeadStatus[] = ['da_lien_he', 'dang_ky_hoc_thu', 'da_chot']
