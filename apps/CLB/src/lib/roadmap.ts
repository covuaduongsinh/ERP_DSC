...
export const levelOrder: ChessLevel[] = brand.roadmap.map((step) => PIECE_TO_LEVEL[step.piece])
 ...
 */
export function levelFromCapChinh(capChinh: Student['capChinh']): ChessLevel | null {
...
export const trackOrder: readonly TrackName[] = ['nhap_mon', 'co_ban', 'nang_cao'] as const
