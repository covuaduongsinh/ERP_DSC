    ...
    components: {
      ...
      views: {
        ...
        publishProgressReports: {
          Component: '/components/admin/progress-reports/PublishQueueView#PublishQueueView',
          path: '/phat-hanh-bao-cao',
          exact: true,
        },
        renewalQueue: {
          Component: '/components/admin/renewals/RenewalQueueView#RenewalQueueView',
          path: '/duyet-gia-han',
          exact: true,
        },
        kpiReport: {
        ...
        quickAttendance: {
          Component: '/components/admin/attendance/QuickAttendanceView#QuickAttendanceView',
        ...
        sessionBalance: {
          Component: '/components/admin/sessions/SessionBalanceView#SessionBalanceView',
          path: '/so-buoi-ton',
          exact: true,
        },
        sessionFeedback: {
