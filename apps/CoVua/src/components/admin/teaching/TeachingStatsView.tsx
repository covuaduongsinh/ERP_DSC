      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            ...
            {stats.fromISO.slice(0, 10)}). Tổng {stats.totalSessions} buổi. Buổi dạy bù tính
            riêng; buổi hủy không tính “đã dạy”.
          </p>
          ...
          {coachSchedules.length === 0 ? (
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              {coachSchedules.map((c) => (
                <div key={c.name} style={{ border: '1px solid var(--theme-elevation-150)', borderRadius: 6, padding: 12 }}>
