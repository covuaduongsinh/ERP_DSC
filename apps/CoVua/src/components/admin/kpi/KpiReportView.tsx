      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Tổng hợp chỉ số vận hành: lead theo tuần & nguồn, tỉ lệ chuyển đổi,
            tái tục, điểm danh trung bình, doanh thu và dòng tiền Thu − Chi.
          </p>
        </header>
    ...
    <div>
      ...
      >
        <span style={{ color: 'var(--theme-elevation-600)' }}>
          ...
          <strong>{formatDateUtc(window.to)}</strong> ({window.weeks} tuần, mốc
          Thứ Hai/UTC)
        </span>
      ...
      >
        ...
        <div style={statRowStyle}>
          <Stat
            label="Lead → Thử"
            value={formatPercent(leads.funnel.rateLeadToTrial)}
            accent
          />
          <Stat
      ...
      <Section
        ...
        sql="leads WHERE created_at ∈ cửa sổ — GROUP BY source"
      >
      ...
      >
        <div style={statRowStyle}>
          ...
          <Stat
            label="Tỉ lệ có mặt"
            value={formatPercent(attendance.presentRate)}
            accent
          />
        </div>
      </Section>
      ...
      >
        <div style={statRowStyle}>
          ...
          <Stat
            label="Mua khác (không tính)"
            value={formatVnd(revenue.muaKhac)}
            muted
          />
        </div>
