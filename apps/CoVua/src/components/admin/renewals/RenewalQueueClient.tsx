...
export function RenewalQueueClient({
  ...
  const suggestedEndDate = useMemo(
    () => suggestExpectedEndDate(startDate, pkg),
    [startDate, pkg],
  );
  ...
  const handleApprove = useCallback(
    (id: number) => {
      ...
      startTransition(async () => {
        ...
        closePanel();
        setSuccess(
          `Đã duyệt: tạo chu kỳ ${res.sessionsTotal} buổi (mã #${res.tuitionCycleId}).`,
        );
        router.refresh();
      });
    },
                      ...
                      <td colSpan={6}>
                        <div className="ds-card">
                          ...
                          <div className="ds-btns">
                            ...
                            <Button buttonStyle="secondary" type="button" disabled={isPending} onClick={closePanel}>
                              Hủy
                            </Button>
                          </div>
                        </div>
