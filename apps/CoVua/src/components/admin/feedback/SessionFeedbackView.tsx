          ...
          <>
            <header style={{ marginBottom: 16 }}>
              ...
              <p style={{ color: 'var(--theme-elevation-500)' }}>
                Xem lại nhận xét từng buổi của học viên. Chọn{' '}
                <strong>Theo buổi dạy</strong> để xem nhận xét cả lớp trong một buổi, hoặc{' '}
                <strong>Theo học viên</strong> để xem tiến bộ của một em qua các buổi. Có thể
                sửa nhận xét ngay tại chỗ, lọc theo cơ sở/thứ/lớp và sửa hàng loạt.
              </p>
            </header>
