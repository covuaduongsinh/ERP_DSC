      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Chọn lớp và ngày, tick có mặt/vắng/phép cho cả lớp rồi lưu một lần.
            Ghi lại cùng ngày sẽ cập nhật, không tạo trùng — buổi “có mặt” tự cộng
            vào số buổi đã học của chu kỳ.
          </p>
        </header>
        {classes.length === 0 ? (
          <p style={{ color: 'var(--theme-elevation-500)' }}>
