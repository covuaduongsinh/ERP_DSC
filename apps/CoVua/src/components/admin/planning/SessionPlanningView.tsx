      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Chọn lớp và khoảng ngày, xem trước rồi sinh trước chuỗi buổi{' '}
            <strong>dự kiến</strong> từ lịch học tuần, sau đó soạn nội dung từng buổi.
            Buổi dự kiến <strong>chưa tính học phí</strong> (chỉ buổi có điểm danh
            “có mặt” mới trừ buổi).
          </p>
        </header>
        {classes.length === 0 ? (
