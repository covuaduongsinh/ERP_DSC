...
const LEVEL_LABELS = new Map(
  chessLevelSelectOptions().map((o) => [o.value, o.label]),
);
      ...
      <Gutter>
        <header style={{ marginBottom: 16 }}>
          ...
          <p style={{ color: 'var(--theme-elevation-500)' }}>
            Báo cáo nháp chưa hiển thị cho phụ huynh. Chọn các báo cáo đã hoàn
            thiện rồi phát hành — sau khi xác nhận, phụ huynh sẽ thấy ngay.
          </p>
        </header>
        <PublishQueueClient
