  ...
  const handlePublish = useCallback(() => {
    ...
    startTransition(async () => {
      ...
      const resolved = new Set([
        ...response.publishedIds,
        ...response.alreadyPublishedIds,
      ]);
      ...
      {phase === 'confirm' ? (
        <div className="ds-notice ds-notice--warning">
          ...
          <div className="ds-btnrow">
            <Button buttonStyle="primary" type="button" disabled={isPending} onClick={handlePublish}>
        ...
        <>
          {phase === 'select' ? (
            <div className="ds-toolbar">
              ...
              >
                {selectedCount === 0 ? 'Phát hành (chưa chọn)' : `Phát hành ${selectedCount} báo cáo…`}
              </Button>
