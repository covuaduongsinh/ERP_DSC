...
export function isImportKind(value: unknown): value is ImportKind {
  return (
    typeof value === 'string' && (IMPORT_KINDS as string[]).includes(value)
  );
}
...
export const IMPORT_KIND_META: Record<ImportKind, ImportKindMeta> = {
  ...
  classes: {
    ...
    template: {
      ...
      headers: ['ten_lop', 'cap_do', 'nhom_tuoi', 'co_so', 'gv', 'tro_giang', 'si_so_toi_da', 'trang_thai', 'lich_hoc'],
      sampleRows: [
        ['Lớp Tốt 1 - Kim Liên', 'Tốt', 'Cấp 1 - Cấp 2', 'Kim Liên', 'Quyên', '', '15', 'Đang mở', 'T2 17:00-18:30 A1; T5 17:00-18:30 A1'],
        ['Lớp Mầm non sáng - Vĩnh Phúc', 'Tốt', 'Mầm non', 'Vĩnh Phúc', 'Trúc', '', '12', 'Đang mở', 'T7 09:00-10:30'],
      ],
    },
  },
  enrollments: {
    ...
    template: {
      ...
      headers: ['ten_hoc_vien', 'ma_hoc_vien', 'sdt_phu_huynh', 'ten_lop', 'dang_hoc', 'ngay_bat_dau'],
      sampleRows: [
        ['Nguyễn Văn An', '', '0912345678', 'Lớp Tốt 1 - Kim Liên; Lớp Nâng cao - Kim Liên', 'Có', '2026-01-15'],
