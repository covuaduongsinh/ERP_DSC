...
async function main() {
  ...
  await payload.update({ collection: 'students', id: studentA, data: { parents: [parentA] }, overrideAccess: true });
  await payload.update({ collection: 'students', id: studentB, data: { parents: [parentB] }, overrideAccess: true });
