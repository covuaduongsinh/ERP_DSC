...
describe('findScheduleConflicts', () => {
  ...
  ): TimetableClass => ({ id, title, coaches, locationId, locationName: null, trangThai: 'dang_mo', slots });
  ...
  it('khác GV + khác phòng ⇒ không trùng', () => {
    const a = mk(10, 'X', [{ id: 1, name: 'A' }], 1, [{ thu: 't2', gioBatDau: '17:00', gioKetThuc: '18:30' }]);
    const b = mk(11, 'Y', [{ id: 2, name: 'B' }], 1, [{ thu: 't2', gioBatDau: '17:00', gioKetThuc: '18:30' }]);
    expect(findScheduleConflicts([a, b])).toHaveLength(0);
  });
});
